...
# Paths
# path to the data
DATA_DIR    = os.path.join('/space/mcdonald-syn01/1/projects/ank028/workspace/figaan_packaged/data_brain')
# Path to load the noise and image from 
LOAD_DIR    = os.path.join(os.getcwd(), 'sample_output')
# path to the output
OUTPUT_DIR  = os.path.join(os.getcwd(), 'sample_output')
# path to where generated images will be stored
SAMPLES_DIR = os.path.join(OUTPUT_DIR, "images")
# path to where model checkpoints will be stored
MODELS_DIR  = os.path.join(OUTPUT_DIR, "models")

# use this to load saved weights 
# WEIGHTS_DIR = os.path.join(os.getcwd(), "output_stylegan")
...
SAVE_FREQUENCY = 10000   # Save frequency for weights (steps)
